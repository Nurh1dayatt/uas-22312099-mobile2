...
class BarangController extends GetxController {
  ...
  Future<QuerySnapshot<Object?>> GetData() async {
    CollectionReference barang_22312099 =
        firestore.collection('barang_22312099');

    return barang_22312099.get();
  }

  Stream<QuerySnapshot<Object?>> streamData() {
    CollectionReference barang_22312099 =
        firestore.collection('barang_22312099');
    return barang_22312099.snapshots();
  }
  ...
  Future<DocumentSnapshot<Object?>> GetDataById(String id) async {
    DocumentReference docRef = firestore.collection("barang_22312099").doc(id);
  ...
  void Update(String nama_barang, String kode_barang, String harga_barang,
      String id) async {
    DocumentReference barang_22312099ById =
        firestore.collection("barang_22312099").doc(id);

    try {
      await barang_22312099ById.update({
        "nama_barang": nama_barang,
        "kode_barang": kode_barang,
        "harga_barang": harga_barang,
      });
